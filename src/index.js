...
(function () {
  ...
  function injectStyle() {
    ...
    var text = [
      ...
      'body.' + BODY_CLASS + ':has(.agnative-topnav-shell .focus) .items-line.layer--visible.layer--render.items-line--type-default, body.' + BODY_CLASS + ':has(.agnative-topnav-rightdock .focus) .items-line.layer--visible.layer--render.items-line--type-default { padding-top:5.5em !important; }',
      'body.' + BODY_CLASS + ':has(.agnative-topnav-shell .focus) .items-line.layer--visible.layer--render.items-line--type-default ~ .items-line.layer--visible.layer--render.items-line--type-default, body.' + BODY_CLASS + ':has(.agnative-topnav-rightdock .focus) .items-line.layer--visible.layer--render.items-line--type-default ~ .items-line.layer--visible.layer--render.items-line--type-default { padding-top:0 !important; }',
