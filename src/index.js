...
(function () {
  ...
  function injectStyle() {
    ...
    var text = [
      ...
      'body.' + BODY_CLASS + ' .agnative-hero { position:fixed; top:0; left:0; width:100vw; height:80vh; min-height:480px; margin:0; padding:0; overflow:visible; box-sizing:border-box; opacity:1; transition:opacity .5s ease; z-index:15; pointer-events:none; }',
      'body.' + BODY_CLASS + ' .agnative-hero.agnative-hero--visible { pointer-events:auto; }',
      'body.' + BODY_CLASS + ' .agnative-hero.agnative-hero--hidden, body.' + BODY_CLASS + ' .agnative-hero.agnative-hero--unfocused { opacity:0 !important; pointer-events:none !important; }',
