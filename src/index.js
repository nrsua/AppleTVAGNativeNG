...
(function () {
  ...
  function injectStyle() {
    ...
    var text = [
      ...
      '  display: none !important;',
      '}',
      'body.' + BODY_CLASS + ' .activity--active .activity__body, body.' + BODY_CLASS + ' .activity--active .scroll, body.' + BODY_CLASS + ' .activity--active .scroll__content { padding-top:0 !important; transition:padding-top .4s cubic-bezier(.22,.61,.36,1) !important; }',
      ...
      'body.' + BODY_CLASS + ' .items-line.layer--visible.layer--render.items-line--type-default:has(.card.focus), body.' + BODY_CLASS + ' .items-line.layer--visible.layer--render.items-line--type-default:has(.card.hover), body.' + BODY_CLASS + ' .items-line.layer--visible.layer--render.items-line--type-default:has(.card-episode.focus), body.' + BODY_CLASS + ' .items-line.layer--visible.layer--render.items-line--type-default:has(.card-episode.hover) { transform:translateY(1.2em) !important; }',
      ...
      'body.' + BODY_CLASS + ' .agnative-hero { position:relative; width:auto; margin:-4em -2em 2em; height:80vh; min-height:480px; overflow:visible; box-sizing:content-box; border-radius:0; opacity:1; transition:opacity .6s ease, padding-bottom .4s cubic-bezier(.22,.61,.36,1); flex-shrink:0; display:block; z-index:8; }',
      'body.' + BODY_CLASS + ' .agnative-hero.agnative-hero--visible { padding-bottom:5em; }',
      'body.' + BODY_CLASS + ' .agnative-hero.agnative-hero--visible.agnative-hero--unfocused { padding-bottom:12em; }',
