  ...
  (function () {
    ...
    function buildHeroBanner() {
      try {
        ...
        // bg is positioned fixed in CSS (fullscreen background)
    ...
    function injectStyle() {
      ...
      var text = [
        ...
        '  display: none !important;',
        '}',
        /* hero is position:fixed — no need to zero out scroll padding-top; other screens keep their native spacing */
        'body.' + BODY_CLASS + '.agnative-has-hero .activity--active .scroll__content > .agnative-hero + .items-line--type-default:first-of-type,',
        'body.' + BODY_CLASS + '.agnative-has-hero .activity--active .scroll__content > .items-line--type-default:first-child { margin-top:calc(80vh + 2em) !important; transition:margin-top .4s cubic-bezier(.22,.61,.36,1) !important; }',
        'body.' + BODY_CLASS + '.agnative-hero-collapsed.agnative-has-hero .activity--active .scroll__content > .items-line--type-default:first-child { margin-top:5em !important; }',
        'body.' + BODY_CLASS + ':not(.agnative-has-hero) .activity--active .scroll__content > .items-line--type-default:first-child { margin-top:0 !important; }',
        /* Hero itself is fixed so scroll__content keeps its native padding-top on all screens */
        ...
        /* hero is fixed — sits above content, doesn't push layout down */
        'body.' + BODY_CLASS + ' .agnative-hero { position:fixed; top:0; left:0; width:100vw; height:80vh; min-height:480px; margin:0; padding:0; overflow:visible; box-sizing:border-box; border-radius:0; opacity:1; transition:opacity .6s ease; flex-shrink:0; display:block; z-index:8; pointer-events:none; }',
        'body.' + BODY_CLASS + ' .agnative-hero.agnative-hero--visible { pointer-events:auto; }',
        'body.' + BODY_CLASS + ' .agnative-hero.agnative-hero--hidden { opacity:0; pointer-events:none; }',
        ...
        /* when hero is collapsed (focus moved to cards) hide it — margin-top on first items-line handles spacing */
        'body.' + BODY_CLASS + '.agnative-hero-collapsed .agnative-hero { opacity:0 !important; pointer-events:none !important; }',
        'body.' + BODY_CLASS + '.agnative-hero-collapsed .agnative-hero__bg { opacity:0 !important; }',
