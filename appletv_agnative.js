  ...
  (function () {
    ...
    function injectStyle() {
      ...
      var text = [
        ...
        'body.' + BODY_CLASS + ' .agnative-hero { position:relative; width:auto; margin:-4em -2em 2em; height:80vh; min-height:480px; padding-bottom:0; overflow:visible; box-sizing:content-box; border-radius:0; opacity:1; transition:opacity .6s ease, padding-bottom .4s cubic-bezier(.22,.61,.36,1); flex-shrink:0; display:block; z-index:8; }',
        'body.' + BODY_CLASS + ' .agnative-hero.agnative-hero--unfocused { padding-bottom:8em; }',
